...
build\mode13h.exe : build\main.obj build\Mode13h.obj build\Bitmap.obj build\BitmapInfoPrinter.obj build\BitmapLoader.obj .AUTODEPEND
 @%write build\mode13h.lk1 FIL build\main.obj,build\Mode13h.obj,build\Bitmap.obj,build\BitmapInfoPrinter.obj,build\BitmapLoader.obj
