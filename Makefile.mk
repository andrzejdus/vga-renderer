...
build\PlanarSprite.obj : src\PlanarSprite.cpp .AUTODEPEND
 *wpp src\PlanarSprite.cpp -i="C:\WATCOM/h" -w4 -e25 -od -d2 -bt=dos -fo=build\PlanarSprite.obj -ml -xs -xr

build\VgaRenderer.exe : build\main.obj build\VgaRenderer.obj build\BmpBitmap.obj build\BmpBitmapInfoPrinter.obj build\BitmapLoader.obj build\Sprite.obj build\PlanarSprite.obj .AUTODEPEND
 @%write build\VgaRenderer.lk1 FIL build\main.obj,build\VgaRenderer.obj,build\BmpBitmap.obj,build\BmpBitmapInfoPrinter.obj,build\BitmapLoader.obj,build\Sprite.obj,build\PlanarSprite.obj
